...
func main() {
	flag.StringVar(&apiKey, "key", "", "Mercury API key")
	...
	if apiKey == "" {
		fmt.Println("Must set Mercury API key, get one at https://mercury.postlight.com/web-parser/ ")
		fmt.Println("Then set it with")
		fmt.Println("    -key YOUR_API_KEY")
		return
	}
